...
class HomeViewModel: ObservableObject {
    ...
    init() {
        // since SwiftUI usese @published so its a publisher...
    ...
    func searchCharacter() {
        ...
        session.dataTask(with: URL(string: url)!) { (data, _, err) in
            ...
            do {
                ...
                let characters = try JSONDecoder().decode(APIReseult.self, from: APIData)
    ...
    func fetchComics() {
        ...
        session.dataTask(with: URL(string: url)!) { (data, _, err) in
            ...
            do {
                ...
                let comics = try JSONDecoder().decode(APIComicReseult .self, from: APIData)
